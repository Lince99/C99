 ...
 */
void print_tree(karyNode* root, int level) {
    int i = 0;
 ...
 */
karyNode* add_node(karyNode* root, int val) {
    karyNode* new = NULL;
    ...
    if(root->n_leaves == 0 || root->n_leaves == MAX_LEAFS) {
        root->leaves = (karyNode**) malloc(sizeof(karyNode*));
 ...
 */
karyNode* add_leaf(karyNode* root, karyNode* leaf) {
 ...
 */
karyNode* fill_tree_user(karyNode* root, int max_leaf) {
    karyNode* tmp = NULL;
    int val = 0;
    char scelta = 0;
    int n_leaf = 0;
 ...
 */
karyNode* get_leaf_node(karyNode* root, int pos) {
 ...
 */
int free_subtree(karyNode* root, int pos) {
